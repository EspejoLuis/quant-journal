...
template <typename T> class PdeEngine : public Engine {
  ...
  public:
    ...
    void calculate() override {
        ...
        for (int i = 0; i <= pdeParams_.nSpaceSteps; i++)
            valuesCurrent[i] = args_.payoff(grid_.spaceGrid[i]);
        ...
        case PdeScheme::Explicit: {
            ...
            cflCondition();
            result_ = explicitMethod(valuesCurrent, valuesNext);
            break;
        }
  ...
  private:
    ...
    void validateInputs() const {
        ...
        if (pdeParams_.grid != PdeGrid::Log &&
            pdeParams_.grid != PdeGrid::Uniform)
    ...
    void defineGrid() {
        ...
        grid_.timeDelta =
            modelParams_.timeHorizonInYears / pdeParams_.nTimeSteps;
    };
    ...
    double explicitMethod(std::vector<double> valuesCurrent,
        ...
        return interpolationLinear(
            ...
            grid_.spaceGrid[idx], valuesCurrent[idx - 1], valuesCurrent[idx]);
    };
